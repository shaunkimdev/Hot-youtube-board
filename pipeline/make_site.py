...
<div class="wrap">
  <section class="hero">
    ...
    <p>한국·일본·미국 유튜브를 <b>해외반응·스캔들·IT·돈·여행·갈등·e스포츠·연애·사회핫이슈·라이프·일본핫이슈·한일글로벌</b> 12개 주제별로 모아 <b>개인 크리에이터 채널의 롱폼</b> 영상만 추렸습니다(<b>쇼츠·라이브 제외</b>). 한일글로벌은 해외 채널의 한국·일본·한일 관련 영상을 별도로 모은 특별 카테고리입니다.</p>
    <div class="stats">
...
<footer class="ft"><div class="wrap">
  <b>방법론</b> · YouTube Data API 검색(KR/JP/US, 12개 주제, 국가별 현지어 검색어) 수집 → 음반사·방송사·신문사·게임사·공식 아티스트 채널 제외 후 개인채널만 추출. 한일글로벌은 해외 영어권 검색 결과 중 한일 연관성을 재검증하고 화제성 Top3를 선정.
...
<script>
const DATA = __DATA__;
const TOPICS = ["해외반응","스캔들","IT","돈","여행","갈등","e스포츠","연애","사회핫이슈","라이프","일본핫이슈","한일글로벌"];
const TCOLOR = {"해외반응":"#1971c2","스캔들":"#9c36b5","IT":"#0c8599","돈":"#f08c00","여행":"#0ca678","갈등":"#e03131","e스포츠":"#4263eb","연애":"#e64980","사회핫이슈":"#e8590c","라이프":"#2f9e44","일본핫이슈":"#7048e8","한일글로벌":"#d6336c"};
